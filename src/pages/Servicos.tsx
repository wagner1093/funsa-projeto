...
const services = [{
  ...
  details: ["Atendimento imediato em qualquer horário", "Equipe especializada e treinada", "Traslado sem limite de quilometragem", "Suporte completo em todas as etapas", "Documentação e providências legais", "Floricultura e ornamentação"],
  image: heroImg,
  ...
  details: ["Consultas médicas em diversas especialidades", "Atendimento odontológico completo", "Exames laboratoriais e de imagem", "Descontos em farmácias parceiras", "Agendamento online e presencial", "Rede credenciada ampla"],
  image: clinicImg,
  ...
  details: ["Infraestrutura moderna e bem cuidada", "Segurança e monitoramento 24h", "Jardins bem cuidados e ambientes de paz", "Diferentes tipos de jazigos", "Manutenção permanente inclusa", "Localização privilegiada em Avaré"],
  image: memorialImg,
  ...
  details: ["Preservação da aparência natural", "Equipe altamente qualificada", "Técnicas modernas e respeitosas", "Dignidade e cuidado em cada detalhe", "Preparo estético personalizado", "Ambiente controlado e seguro"],
  image: heroImg,
  cta: "Saiba Mais",
  ctaHref: "/contato"
}];
export default function Servicos() {
  return <>
      <PageHero title="Nossos Serviços" subtitle="Oferecemos uma estrutura completa de serviços para atender às necessidades da sua família com excelência e humanidade." breadcrumbs={[{
      ...
      <section className="section-padding bg-background">
        <div className="section-container space-y-24">
          {services.map((s, i) => <ScrollReveal key={s.title}>
              <div className={`grid lg:grid-cols-2 gap-12 items-center ${i % 2 !== 0 ? "lg:direction-rtl" : ""}`}>
                ...
                <div className={i % 2 !== 0 ? "lg:order-1" : ""}>
                  ...
                  <div className="mt-6 grid sm:grid-cols-2 gap-3">
                    {s.details.map(d => <div key={d} className="flex items-start gap-2">
