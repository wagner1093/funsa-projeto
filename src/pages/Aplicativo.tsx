...
const highlights = ["Acesso rápido à carteirinha virtual", "Guia médico sempre atualizado", "Clube de descontos exclusivos", "Promoções e novidades em tempo real"];
const faqs = [{
  q: "O aplicativo é gratuito?",
  a: "Sim, o aplicativo FUNSA é totalmente gratuito para download e uso por todos os associados."
}, {
  q: "Onde posso baixar?",
  a: "O aplicativo está disponível na App Store (iOS) e Google Play (Android)."
}, {
  q: "Preciso ter plano para usar?",
  a: "Algumas funcionalidades são exclusivas para associados, mas o download é aberto a todos."
}, {
  q: "Como acessar minha carteirinha?",
  a: "Após o login com seus dados de associado, acesse a seção 'Carteirinha Virtual' no menu principal."
}];
export default function Aplicativo() {
  return <>
      <PageHero title="Aplicativo FUNSA" subtitle="Praticidade e acesso rápido a todos os serviços e informações do seu plano, na palma da sua mão." breadcrumbs={[{
      label: "Aplicativo",
      href: "/aplicativo"
    }]} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <ScrollReveal>
              <div className="relative flex justify-center">
                ...
                <img src={appMockup} alt="Aplicativo FUNSA na tela do smartphone" className="relative w-full max-w-sm lg:max-w-md rounded-3xl shadow-2xl" />
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.15}>
              ...
              <ul className="mt-8 space-y-4">
                {highlights.map(item => <li key={item} className="flex items-center gap-3">
        ...
        <div className="section-container text-center">
          <ScrollReveal>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="#" className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-card/10 border border-primary-foreground/20 text-primary-foreground hover-lift">
        ...
        <div className="section-container max-w-3xl">
          ...
          <ScrollReveal delay={0.1}>
            <Accordion type="single" collapsible className="space-y-3">
              {faqs.map((faq, i) => <AccordionItem key={i} value={`faq-${i}`} className="bg-card border border-border/50 rounded-xl px-6 data-[state=open]:shadow-md transition-shadow">
