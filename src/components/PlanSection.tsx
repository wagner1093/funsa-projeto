    ...
    <section id="plano" className="section-padding gradient-navy">
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal>
            <span className="text-sm font-semibold text-azure uppercase tracking-widest">Plano de Assistência</span>
            ...
            <a
              href="#contato"
              className="mt-8 btn-primary-dark text-base"
            >
              Contratar Plano
              ...
              <div className="space-y-4">
                {included.map((item) => (
                  <div key={item} className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-azure flex items-center justify-center flex-shrink-0 mt-0.5">
